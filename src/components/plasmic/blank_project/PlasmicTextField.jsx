...
import Label from "../../Label"; // plasmic-import: 27pkw6Hvrsjk/component
import TextInput from "../../TextInput"; // plasmic-import: NA9vONYumA33/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Oumf4WZuJOJ5/component
import Description from "../../Description"; // plasmic-import: zPg2G2RlXFL8/component
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: 2ek6Cg6a7WkgAmyEDdQ7vg/styleTokensProvider
import "@plasmicapp/react-web/lib/plasmic.css";
import * as projectcss from "./plasmic.module.css"; // plasmic-import: 2ek6Cg6a7WkgAmyEDdQ7vg/projectcss
import * as sty from "./PlasmicTextField.module.css"; // plasmic-import: 3fF63zdMPzIx/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: I7XBc7t-n-Qt/icon
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__psyt9, {
          [sty.freeBoxiconEnd__psyt9JGX]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__psyt9DgUgi]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__psyt9Haa3J]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___2W3Tv, {
            [sty.freeBoxiconStart___2W3TvdgUgi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___2W3TvHaa3J]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___2PwnJ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__pm7Sn, {
            [sty.freeBoxiconEnd__pm7SNjGX]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__pm7SNdgUgi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__a5Bws)}
                role={"img"}
              />
            ),
